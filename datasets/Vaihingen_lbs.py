...
class VaiDataset(PointCloudDataset):
    ...
    def __init__(self, config, set='training', use_potentials=True, load_data=True):
        ...
        self.ignored_labels = np.array([10])#np.array([10])
        ...
        config.num_classes = self.num_classes-1
    ...
    def potential_item(self, batch_i, debug_workers=False):
        ...
        while True:
            ...
            with self.worker_lock:
                ...
                center_point = pot_points[point_ind, :].reshape(1, -1) # get the central point
            ...
            # make sure there are points in each input sphere
            if n==0:
                print('Maybe subsampling is too large.')
                continue
            ...
            if self.set in ['test', 'ERF']:
                ...
                # print('self.label_to_idx: ', self.label_to_idx)
        ...
        for i, file_path in enumerate(self.files):
            ...
            if exists(KDTree_file):
                ...
                if self.set in ['validation', 'test']:
                    ...
                    # print(sub_labels)
                    fn_pseudo = '.../test/'+self.model_n+'/'+cloud_name+'_'+self.ck+ '_pseudo.txt'
                    print(fn_pseudo)
                    sub_labels = np.genfromtxt(fn_pseudo).astype('int32') # data['preds']
                    print('load pesudo labels')
                    print(sub_labels)
                    sub_colors = data['intensity'].T 
